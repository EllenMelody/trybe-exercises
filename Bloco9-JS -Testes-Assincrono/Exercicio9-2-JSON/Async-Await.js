...
// O await só pode ser usado dentro de uma função com async e ela faz exatamente o que diz, 
//faz a função esperar uma resposta para continuar sua execução. Vamos refatorar a fetchJoke :
